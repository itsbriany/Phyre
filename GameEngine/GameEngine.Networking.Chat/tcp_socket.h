...
namespace Networking
{
	...
	public:
		...
		// Arg1: Error on read
		// Arg2: Data read
		typedef std::function<void(const boost::system::error_code&, const std::string&)> OnWriteCallback;
		...
		virtual void Write(const std::string& data, OnWriteCallback callback) = 0;
