...
//// TODO: GET RID OF THIS MEMORY MANAGER!!!
...
//    if (!CanFindMemoryTypeFromProperties(device_, memory_requirements.memoryTypeBits, requirements_mask, allocate_info.memoryTypeIndex)) {
...
//
//    return VulkanUniformBuffer(device_, device_memory, vk::DescriptorBufferInfo(uniform_buffer.buffer(), 0, sizeof(uniform_buffer.mvp())));
//}
