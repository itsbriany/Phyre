...
public:
    ...
    explicit VulkanSwapchainDeprecated(const VulkanMemoryManager& memory_manager,
...
private:
    ...
    static DepthImage VulkanSwapchainDeprecated::InitializeDepthImage(const VulkanMemoryManager& memory_manager, 
                                                             const VulkanGPU& gpu,
                                                             const vk::Device& device,
                                                             uint32_t width, 
                                                             uint32_t height,
